...
class Ui_staff_interface(object):
    def setupUi(self, staff_interface):
        ...
        staff_interface.resize(894, 643)
        ...
        staff_interface.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.update_orders_btn.setGeometry(QtCore.QRect(340, 550, 141, 41))
        self.update_orders_btn.setObjectName("update_orders_btn")
        self.ordersTableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.ordersTableWidget.setGeometry(QtCore.QRect(260, 110, 571, 411))
        ...
        self.ordersTableWidget.horizontalHeader().setDefaultSectionSize(93)
        ...
        self.update_menu_btn.setGeometry(QtCore.QRect(490, 40, 151, 41))
        self.update_menu_btn.setObjectName("update_menu_btn")
        self.logout_btn = QtWidgets.QPushButton(self.centralwidget)
        self.logout_btn.setGeometry(QtCore.QRect(660, 40, 171, 41))
        self.logout_btn.setMinimumSize(QtCore.QSize(1, 0))
        self.logout_btn.setObjectName("logout_btn")
        self.gen_report_btn = QtWidgets.QPushButton(self.centralwidget)
        self.gen_report_btn.setGeometry(QtCore.QRect(560, 550, 211, 41))
        self.gen_report_btn.setObjectName("gen_report_btn")
    ...
    def retranslateUi(self, staff_interface):
        ...
        self.gen_report_btn.setText(_translate("staff_interface", "Generate Sales Report"))
